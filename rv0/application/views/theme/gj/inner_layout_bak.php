...
<div class="site-container" id="site-container">
  <header class="navbar-static-top">
      ...
      <?php } ?>
          ...
          <div class="pull-right login-strip">
            <ul class="nav navbar-nav navbar-right profile-menu profile-menu-desktop">
              ...
              <li class="notifi-count"><a href="#" class="dropdown-toggle" type="button" id="dropdownMenu2" title="Notifications" data-toggle="dropdown" aria-haspopup="true" onClick="updatepoststatus();" aria-expanded="true"><i class="fa fa-bell" aria-hidden="true"></i>
	  ...
	  ?>
		...
		?>
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
				  ...
				  <li><a href="javascript:void(0)" onclick="Logout()"><i class="fa fa-lock" aria-hidden="true"></i> Logout</a></li>
				  <?php }else{?>
     ...
     <div class="container-fluid">
	  ...
	  ?>
		...
		?>
          ...
          <li class="<?php if($activepage=='home'){ ?> active <?php } ?> dropdown" role="presentation"><a class="dropdown-toggle" data-toggle=""  href="<?php echo base_url();?>home" role="button" aria-haspopup="true" aria-expanded="false">Home</a>
    ...
    //foreach($pages['pagelist'] as $k=>$v){?>
          ...
          <li class="<?php if($activepage=='connection'){ ?> active <?php } ?> dropdown" role="presentation"><a class="dropdown-toggle" data-toggle="" href="javascript:void(0);" aria-haspopup="true" aria-expanded="false">Network</a>
            <ul class="dropdown-menu">
      ...
      <li><a href="<?php echo base_url();?>connections/getPages/<?php echo $k;?>"><?php echo $k;?></a></li>
          ...
          <li class="<?php if($activepage=='contact'){ ?> active <?php } ?>"><a href="<?php echo base_url();?>contactus">Contact us</a></li>
           <?php if($pages['more'][1]['name']!=''){?>
          <li class="<?php if($activepage=='more'){ ?> active <?php } ?> dropdown"><a href="javascript:void(0);">More</a>
			<ul class="dropdown-menu">
				<?php foreach($pages['more'] as $k=>$v){?>
					<?php if($k!='Alumni'){?>
