				...
				<div>
					 <!-- content starts here-->
					 		<div >
								  ...
								  <input type="text" name="search" id="search" placeholder="Search Product" />&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a name="addproduct"  class="btn btn-info" href="<?php echo base_url('category/product_category');?>">Add Category</a>
							  ...
							  <table class="table">
								   ...
								   <?php $i=1;foreach($data as $key => $value):?>
								      <tr>
								        ...
								        <td><a href="<?php echo base_url('category/category_edit/'.$value->c_name);?>"><?php echo $value->c_name;?></a></td>
								         <td><?php echo $value->c_description;?></td>
								           <td><a href="<?php echo base_url('category/category_delete/'.$value->c_id);?>"><i class="fa fa-trash-o fa-lg"></i></a>&emsp;<a href="<?php echo base_url('category/category_edit/'.$value->c_id);?>"><i class="fa fa-pencil fa-fw"></i></a></td>
								      </tr>
								    <?php $i++; endforeach; ?>
								    </tbody>
								  </table>
