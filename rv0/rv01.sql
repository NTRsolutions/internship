...
--
-- Host: localhost
-- Generation Time: Jun 08, 2017 at 12:27 PM
...
CREATE TABLE IF NOT EXISTS `whd_admin_users` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COMMENT='Admin User Table' AUTO_INCREMENT=319 ;
...
CREATE TABLE IF NOT EXISTS `whd_banner` (
...
CREATE TABLE IF NOT EXISTS `whd_encryption` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `whd_events` (
...
CREATE TABLE IF NOT EXISTS `whd_message` (
...
CREATE TABLE IF NOT EXISTS `whd_messages` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `whd_news` (
...
CREATE TABLE IF NOT EXISTS `whd_ogtags` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `whd_organizations` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `whd_pages` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `whd_sessions` (
...
CREATE TABLE IF NOT EXISTS `whd_site_activity` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `whd_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Stores user data as per type' AUTO_INCREMENT=9 ;
...
CREATE TABLE IF NOT EXISTS `whd_user_activity` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `action_type` varchar(30) DEFAULT NULL,
  `user_id` text,
...
CREATE TABLE IF NOT EXISTS `whd_user_role` (
...
CREATE TABLE IF NOT EXISTS `whd_user_roles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `tenant_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Saves user type' AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `whd_user_status` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 COMMENT='Holds user status data for suspend / unsuspend / closed' AUTO_INCREMENT=2 ;
