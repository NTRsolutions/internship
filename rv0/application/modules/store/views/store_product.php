...
<script src="<?php echo ASSETS;?>assets/js/jquery1.min.js" type="text/javascript"></script>
...
<script src="<?php echo ASSETS;?>assets/js/bootstrap1.min.js" ></script>
        ...
        <tbody>
	         ...
	         <tr><td style="font-size:9px"><?php echo $data->discription;?>  Lorem Ipsum is simply dummy text of the printing and type setting Industry.Lorem Ipsum has been the</td></tr>
	          ...
	          <tr><td style="font-size:9px"><p>scrambled it to make a type specimen book.It has survived not only five countries but also the leap.</p></td></tr>
	           ...
	           <tr><td style="word-spacing:10px"><p><strong>₹<?php echo $data->o_price; ?>/-</strong><strong><strike>₹<?php echo $data->r_price; ?>/-</strike></strong>    QUANTITY    <input type="number" min="1" max="<?php echo $data->quantity;?>" size="2" value="1" style="width:1.5cm" id="quantity" onkeypress="return isNumber(event)"> </p></td></tr>
             <tr><td><span id="outstock" style="color: red"></span></td></tr>
             </tbody> </table>
    ...
    <div class="modal-dialog ">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <input type="text" onClick="this.setSelectionRange(0, this.value.length)" id="link" size="55">
        </div>
...
$("#addtocart").click(function(){
  ...
  document.getElementById("outstock").innerHTML="";
    //alert("hi");
       ...
       var c="<?php echo $data->quantity;?>"/1;
       //alert(c+' '+q);
       if (c < q) {    
                     
          // document.getElementById("quantity").preventDefault();       
           document.getElementById("outstock").innerHTML="Out of stock";  
          // alert("in");       
        }
