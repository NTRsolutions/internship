...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        $('#send').click(function(){
             ...
             var name=$('#name').val();
        	 $.post("<?php echo base_url('sms/create_class/'); ?>",{class:name},function(data){
                $("#class").html(data);
