				...
				<div id="content" class="span10 content">
					 <!-- content starts here-->
					 		<div >
								 ...
								 &emsp;&emsp; <input type="text" name="search" id="search" placeholder="Search Product" />
								  <select id="order" style="display:none;">
								    <option selected="selected">Sort</option>
								  	<option value="price">Price</option>
								  	<option value="alpha">alphabetic</option>
								  </select>
								  &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a name="addproduct"  class="btn btn-info" href="<?php echo base_url('collections/addcollection');?>">Add Collections</a>
							 ...
							 <div class="table-responsive">
							  ...
							  <div class="col-md-offset-5" id="pagination" style="margin-bottom: 40px">
							 <?php
