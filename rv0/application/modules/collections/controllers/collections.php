   ...
   public function index()
    {
             ...
             $config['base_url'] = 'http://localhost/new/rv0/collections/index';
             $config['per_page'] = 8;
             $arr=$this->mdl_collections->dist();
             $c=count($arr);
             $config['total_rows']=$c;
            
             $this->pagination->initialize($config);
            $d['data']=$this->mdl_collections->getcollections($config['per_page'],$this->uri->segment(3));
     ...
     public function price()
    {
             ...
             $config['base_url'] = 'http://localhost/new/rv0/collections/price';
             $config['per_page'] = 8;
             $arr=$this->mdl_collections->dist();
             $c=count($arr);
             $config['total_rows']=$c;
             ...
             $this->pagination->initialize($config);
            $d['data']=$this->mdl_collections->order_price($config['per_page'],$this->uri->segment(3));
        
            $this->load->view("collections_search",$d);
        
        /* $d['data']=$this->product_model->order_price();
         //print_r($d);exit;
         $this->load->view("order_by",$d);*/
    }
    public function alphabetic()
    {
         
             $config['base_url'] = 'http://localhost/new/rv0/collections/alphabetic';
             $config['per_page'] = 8;
             $arr=$this->mdl_collections->dist();
             $c=count($arr);
             $config['total_rows']=$c;
             ...
             $this->pagination->initialize($config);
            $d['data']=$this->mdl_collections->order_alphabetic($config['per_page'],$this->uri->segment(3));
        
            $this->load->view("collections_search",$d);

         /*$d['data']=$this->product_model->order_alphabetic();
         //print_r($d);exit;
         $this->load->view("order_by",$d);*/
    }
    public function do_upload()
        {
                ...
                if (  $this->upload->do_upload('img'))
                {
                        ...
                        $img=$image['file_name'];
                        $data=array('name'=>$c_name,'description'=>$description,'pid'=>'','img'=>$img,'tenant_id'=>TENENT_ID,'quantity'=>$quantity,'price'=>$price,"offerprice"=>$offerprice);
                         $this->mdl_collections->addcollection($data);
                        foreach ($p as $key => $value) {
                         $data=array('name'=>$c_name,'description'=>$description,'pid'=>$value,'img'=>$img,'tenant_id'=>TENENT_ID,'quantity'=>$quantity,'price'=>$price,"offerprice"=>$offerprice);
                         $this->mdl_collections->addcollection($data);
        ...
        public function do_update($oldname)
        {
                ...
                */
                ...
                $data=array('name'=>$name,'description'=>$description,'pid'=>'','tenant_id'=>TENENT_ID,'quantity'=>$quantity,'price'=>$price,"offerprice"=>$offerprice);
                $this->mdl_collections->update($oldname,$value,$data);
                         $d['data']=$data;
                foreach ($p as $key => $value) {
                   
                         $data=array('name'=>$name,'description'=>$description,'pid'=>$value,'tenant_id'=>TENENT_ID,'quantity'=>$quantity,'price'=>$price,"offerprice"=>$offerprice);
                         $d['data']=$data;
                         $this->mdl_collections->update($oldname,$value,$data);
                }
    ...
    public function search()
    {
       ...
       $search=$this->input->post('search');
             ...
             $config['base_url'] = 'http://localhost/new/rv0/collections/search';
             $config['per_page'] = 8;
             $count=$this->mdl_collections->onkey($search);
             $c=count($count);
             //echo $c;exit;
             $config['total_rows']=$c;
             //echo $config['total_rows'];exit;
             $this->pagination->initialize($config);
             $d['data']=$this->mdl_collections->getcollection_onkey($search, $config['per_page'],$this->uri->segment(3));
