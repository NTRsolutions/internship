...
function chatWith(chatuser,displayname) {
	createChatBox(chatuser,displayname);
...
function createChatBox(chatboxtitle,displayname,minimizeChatBox) {
	...
	.addClass("chatbox")
	.html('<div class="chatboxhead"><div class="chatboxtitle">'+displayname+'</div><div class="chatboxoptions"><a href="javascript:void(0)" onclick="javascript:toggleChatBoxGrowth(\''+chatboxtitle+'\')">-</a> <a href="javascript:void(0)" onclick="javascript:closeChatBox(\''+chatboxtitle+'\')">x</a></div><br clear="all"/></div><div class="chatboxcontent"></div><div class="chatboxinput"><textarea class="chatboxtextarea" onkeydown="javascript:return checkChatBoxInputKey(event,this,\''+chatboxtitle+'\');"></textarea></div>')
...
function chatHeartbeat(){
	...
	jQuery.ajax({
	  url: base_url+"chat/chatheartbeat",
	  cache: false,
	  dataType: "json",
...
function closeChatBox(chatboxtitle) {
	...
	jQuery.post(base_url+"chat/closechat", { chatbox: chatboxtitle} , function(data){	
	});
...
function checkChatBoxInputKey(event,chatboxtextarea,chatboxtitle) {
	...
	if(event.keyCode == 13 && event.shiftKey == 0)  {
		...
		if (message != '') {
			jQuery.post(base_url+"chat/sendchat", {to: chatboxtitle, message: message} , function(data){console.log(data);
...
function startChatSession(){  
	jQuery.ajax({
	  url: base_url+"chat/startchatsession",
	  cache: false,
	  dataType: "json",
	  success: function(data) {
