...
<?php include 'page_template.php';?>
	...
	<iframe id="SomeFrameName" style="display: none" name="SomeFrameName" src="about:blank"></iframe>
								  	...
								  	<table class="table" >
										  ...
										  <tr>
										    ...
										    <textarea cols="5" id="discription" name="discription" required></textarea>
										     ...
										     <td><label>Quantity</label><input type="text" class="form-control" id="quantity" name="quantity" onkeypress="return isNumber(event)" required>
										    </td>
										  </tr>
										  <tr>
										    <td> <label >Price</label><br>
										    <input type="text" id="price" name="price" onkeypress="return isNumber(event)" required> 
										    </td>
										     <td><label>Offer price</label><input type="text" class="form-control" id="offerprice" name="offerprice" onkeypress="return isNumber(event)" required>
										    </td>
										  </tr>
										  <!--<tr>
        ...
        <input class="form-control" type="text" name="searchroleName"  placeholder="Search By Name" id="addproducts"/><div class="input-group-addon"><span style="margin:5px 0px 0px 5px;" class="fa fa-search form-control-feedback"></span></div>
										  ...
										  <input type="reset" value="Reset" class="btn btn-info"></center>
										  </td>
										  </tr>
