<?php include "page_template.php";?>
        ...
        <input class="form-control" type="text" name="searchroleName"  placeholder="Search By Name" id="addproducts"/><div class="input-group-addon"><span style="margin:20px 0px 0px 0px;" class="fa fa-search form-control-feedback"></span></div>
    </div>
    ...
    $(document).ready(function(){
		...
		?>
            ...
            $.ajax({
                ...
                url: "http://localhost/new/rv0/category/category_update"+'/'+"<?php echo $value->c_id; ?>",
