...
<html lang="en">
   <head>
      ...
      <?php if($org[0]->organizationType=="school"){ 
         if(empty($gb[0]->passout_year) || empty($gb[0]->branch_name)){  ?>
      <script>
         window.close();
         <?php if($gb[0]->provider=='Facebook'){?>
         window.location.href="<?php echo base_url();?>user/brachUpdate/";
               ...
               <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                     ...
                     <ul class="nav navbar-nav navbar-left mobile-menu">
                        ...
                        <?php } */ ?>
                        <li class="<?php if($activepage=='store'){ ?> active <?php } ?>"><a href="<?php echo base_url();?>store">Store</a></li>
                        <li class="<?php if($activepage=='contact'){ ?> active <?php } ?>"><a href="<?php echo base_url();?>contactus">Contact us</a></li>
                       
                        <li class="<?php if($activepage=='store'){ ?> active <?php } ?>"><a href="<?php echo base_url('store/cart_details');?>" class="cart"><span class="fa fa-shopping-cart " style="font-size:12px">&nbsp;</span>Cart&nbsp;<span class="badge white" id="cartno"><?php 
                     ...
                     <div class="modal-body">
                         ...
                         <div class="social-icons-widget">
                           ...
                           <ul class="social-icons-list">
                              ...
                              <li><a onclick="loginURL('<?php echo base_url(); ?>user/sociallogin/Google?dest-url=<?php echo $dest_url; ?>')"    href="javascript:void(0)">Sign in with Google</a></li>
                             
                              <li><a onclick="loginURL('<?php echo base_url(); ?>user/sociallogin/LinkedIn?dest-url=<?php echo $dest_url; ?>')"  href="javascript:void(0)">Sign in with Linkedin</a></li>
                           </ul>
                        </div>
                        ...
                        <form method="post" name="login_user" id="login_user"   onsubmit="return doLogin()">
                           <div id="slide_container1" class="form-group-container">
                           ...
                           <div class="form-group">
                              <div class="input-group">
                                ...
                                <button  type="submit" class="btn btn-primary"><span>Log in</span> <span style="display:none" class="loader-btn load-layout-image"><i class="fa fa-spinner fa-pulse"></i></span></button>
                               
                               
                               
                               <input type="hidden" name="dest_url" id="dest_url" value="<?php echo $dest_url; ?>"/>
                           <div class="form-group remember-widget">
                              <span class="pull-right rememberMe">
                                 <!--<label>
                              ...
                              <span class="pull-left signUp"> No account? <a href="<?php echo base_url().'register';?>">Sign up</a> </span> 
                           </div>
                            ...
                            <a id="slide1" class="btn btn-primary slide_btn"><span>Log in with Email</span></a>    
                  ...
                  <div class="forgot-holder" style="display:none">
                     ...
                     <div class="modal-body">
                        ...
                        <form method="post" name="forgot_user" id="forgot_user"    onsubmit="return doForgot()">
                           ...
                           <button type="submit" class="btn btn-primary"><span class="">Reset Password </span> <span style="display:none;" class="loader-btn load-forgot-image"><i class="fa fa-spinner fa-pulse"></i></span></button>
                           <div class="form-group"> <span class="pull-left rememberMe"> </span> <span class=" signUp"> Already have an account? <a href="javascript:void(0)" onclcik="loginblock()" id="login-block">Login instead</a> </span> </div>
                        </form>
                     </div>
                  </div>
               </div>
 ...
 $("#slide1").click(function() {
    ...
    $("#slide_container1").fadeIn('slow');
});
    $("#slide2").click(function() {
     $("#slide2").css('display','none');
     $(".login_description").hide();
    $("#slide_container2").fadeIn('slow');
});  
