								  	...
								  	<table class="table">
									      ...
									      <tr>
												 ...
												 <td><div class="form-group">
													  ...
													  <input type="text" class="form-control" id="p_name" name="p_name" required><br>
													</div></td>
												<td>
													<label >status</label>
										  ...
										  <tr>
										    <td>Description<br>
										    <textarea cols="5" id="discription" name="discription" required> </textarea><br>
										    </td>
										    <td>
										  ...
										  <tr>
												 <td>
												 	<div class="form-group">
													  ...
													  <input type="text" class="form-control" name="o_price" id="o_price" required><br>
													</div>
													<div class="form-group">
													  <label >Retails price:</label>
													  <input type="text" class="form-control" name="r_price" id="r_price" required><br>
													</div>
													<div class="form-group">
													  <label >Sale Price:</label>
													  <input type="text" class="form-control" id="s_price" name="s_price" required><br>
													</div>
													<div class="form-group">
													  <label >Cost Price:</label>
													  <input type="text" class="form-control" id="c_price" name="c_price" required><br>
													</div>
													<div class="form-group">
													  <label >SRP:</label>
													  <input type="text" class="form-control" id="srp" name="srp" required><br>
													</div>
												 </td> 
											 	 <td colspan="5">
											 	 <h4>Image</h4>
