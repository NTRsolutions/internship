                ...
                <div class="box-body">
                    <div class="box-body chat">
                      <div class="mailbox-read-info">
                        ...
                        <h6>From: <?php echo $sender->email==$this->session->userdata('email') ? "me" : $sender->email; ?> <span class="mailbox-read-time pull-right"><?=date('Y M d @ H.i A', strtotime($message[0]->create_date))?></span></h6>
                        <h6>To: <?php echo $message[0]->email; ?> </h6>
                      ...
                      <!-- <div class="chat"> -->
                        <div class="item">
                            ...
                            <?php }else{ ?>
							<img src="<?php echo base_url("assets/img/user-img.png");?>" alt="user image" class="online"/>
							<?php } ?>
                            <p class="message">
                                <a href="#" class="name">
                    ...
                    <div class="box-footer">
                      <ul class="mailbox-attachments clearfix">
                        <li>
                        <a href="<?=base_url('uploads/attach/'.$message[0]->attach_file_name)?>" target="_blank">
                          <span class="mailbox-attachment-icon"><i class="fa fa-file fa-1x"></i></span>
                          <div class="mailbox-attachment-info">
                            <a href="<?=base_url('uploads/attach/'.$message[0]->attach_file_name)?>" target="_blank" class="mailbox-attachment-name"><i class="fa fa-paperclip"></i>
                            <?php
                                $image = "";
