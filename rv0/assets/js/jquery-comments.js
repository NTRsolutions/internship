...
comment_id:'comment_id',
        ...
        postComment: function(ev) {
			...
			var item_id=$(ev.currentTarget).parents('li').attr('id');
			
            var item_type=$(ev.currentTarget).parents('li').attr('alt');
        ...
        createCommentingFieldElement: function(parentId, existingCommentId) {
            ...
            var saveButton = $('<span/>', {
                'class': saveButtonClass + ' save highlight-background btn btn-primary',
                text: saveButtonText
            });
        ...
        createCommentWrapperElement: function(commentModel) {
            ...
            var time = $('<time/>', {
                text: this.options.timeFormatter(commentModel.created),
				 text: this.options.textFormatter("") + ' ' + commentModel.created,
            ...
            if(commentModel.modified && commentModel.modified != commentModel.created) {
                ...
                var edited = $('<time/>', {
                    'class': 'edited',
                    text: this.options.textFormatter(this.options.editedText) + ' ' + commentModel.modified,
