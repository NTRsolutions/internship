...
{
	protected $scope = array('offline_access', 'email', 'read_stream','manage_pages');
	...
	public function get_user_info(OAuth2_Token_Access $token)
	{
		...
		return array(
			...
			'image' => 'https://graph.facebook.com/me/picture?type=small&access_token='.$token->access_token,
			'urls' => array(
			  'Facebook' => $user->link,
			),
		);
