	...
	<form method="post"  class="form-horizontal" role="form" name="register_user" id="register_user" action="<?php echo base_url('user/doRegister'); ?>"  onsubmit="return formSubmit('register_user')">
  	<!-- Basic inputs -->
		        ...
		        <div class="panel panel-default">
			        <div class="panel-heading"><h6 class="panel-title"><i class="icon-user"></i> Create an Account</h6></div>
	            <?php if($success_msg!='') { ?>
				...
				<?php } ?>
	                <div class="panel-body">
						...
						<div class="plupload_file_name"><div class="plupload_buttons"><button class="plupload_button plupload_add" style="position: relative; z-index: 1;">Sign Up</button></div></div>
