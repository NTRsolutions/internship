        ...
        <div class="box box-solid">
          ...
          <div class="box-body no-padding">
            <ul class="nav nav-pills nav-stacked message">
              <li><a href="<?=base_url('message/index')?>"><i class="fa fa-inbox"></i>
                <?=$this->lang->line('inbox')?>
                <span class="label label-info pull-right" id="inbox"></span></a></li>
              <li class="active"><a href="<?=base_url('message/sent')?>"><i class="fa fa-envelope-o"></i>
                <?=$this->lang->line('sent')?>
                <span class="label label-info pull-right" id="sent"></span></a></li>
             <!-- <li><a href="<?=base_url('message/fav_message')?>"><i class="fa fa-envelope-o"></i>
        ...
        <div class="box box-primary">
          ...
          <div class="box-body">
            <div class="margin-bottom">
              <div class="btn-group">
                <button id="all" class="btn btn-info btn-md"  data-original-title="Select mail" data-toggle="tooltip" data-placement="top" title="Select all"> <i class="fa fa-square-o"></i> </button>
              ...
              <table id="example1" class="table table-hover dataTable no-footer">
                ...
                <tbody>
                  ...
                  <tr class="<?=$message->reply_status==1 ? "unread" : "read"?>">
                    ...
                    <td data-title="<?=$this->lang->line('to')?>" class="mailbox-name"><a href='<?=base_url("message/sent/view/$message->messageID")?>'>
                      <?=(isset($message->sender))?$message->sender:$message->email?>
                      </a></td>
                    <td data-title="<?=$this->lang->line('subject')?>" class="mailbox-subject"><b>
