...
<div style="margin-top:3.5cm;">
	...
	<div class="col-md-offset-1 col-sm-offset-1 col-md-8 col-sm-8" style="margin-top:10px">
		...
		<?php foreach($collections as $k => $key):?>
		 		<div class="col-sm-6 col-md-3 "><figure><a href="<?php echo base_url('store/store_collection/'.$key->name);?>"><img style="width:200px; height:200px" class="img-responsive" src="<?php echo base_url('uploads/collections/'.$key->img);?>"> </a><figcaption><?php echo $key->name;?><br/><strong>Rs.<?php echo $key->offerprice;?></strong></figcaption></figure></div>
		<?php endforeach; ?>
